...
// Fin partie code specifique au Transfer Data
  ...
  E_Float** ipt_gmrestmp;  E_Float** iptdrodm_transfer; E_Float** ipt_tij_model; E_Float** ipt_cutOff;
  ...
  for (E_Int nd = 0; nd < nidom; nd++)
  {
    ...
    //WMLES - Kawai & Tamaki 2021 linearize
   ...
   for (E_Int nstep = nstep_deb; nstep < nstep_fin+1; ++nstep)
   {
     ...
     if (skip ==0)
     {
      gsdr3( 
            ...
            taille_tabs        , iptstk           , iptdrodmstk       , iptcstk          , iptsrc, ipt_tij_model, ipt_cutOff);
