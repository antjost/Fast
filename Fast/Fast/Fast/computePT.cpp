...
PyObject* K_FAST::_computePT(PyObject* self, PyObject* args)
{
  ...
  E_Float** iptS; E_Float** iptFltrN; E_Float** iptPsiG; E_Float** iptSpongeCoef; E_Float** ipt_cutOff;
  ...
  ipt_cutOff        = iptSpongeCoef      + nidom;
	  ...
	  if (skip ==0){
	      ...
	      gsdr3(ipt_param_int      , ipt_param_real    , nidom              , nitrun_loc        ,
		    ...
		    iptcstk            , iptsrc            ,
                    ...
                    aneq_o3            , psi_corr          , flag_NSLBM         , ipt_cutOff);
